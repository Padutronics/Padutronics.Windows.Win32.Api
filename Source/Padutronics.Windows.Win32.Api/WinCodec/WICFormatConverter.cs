...
{
    public WICFormatConverter(nint pointer) :
        base(pointer)
    {
    }
    ...
    {
        WICFormatConverterMethods.IWICFormatConverter_Initialize(This, pISource.Pointer, ref dstFormat, dither, pIPalette?.Pointer ?? nint.Zero, alphaThresholdPercent, paletteTranslate);
    }
}